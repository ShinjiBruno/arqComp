...
architecture a_eq12_proc_top of eq12_proc_top is
    ...
    signal s_isImm: std_logic; --sinal pra indicar se eh instr do tipo I
    signal s_isMov: std_logic; --sinal pra indicar se eh instr do tipo MOV
...
begin
    ...
    s_a1 <= std_logic_vector(s_instr(22 downto 20));
    s_a2 <= "000" when s_isMov = '1' else std_logic_vector(s_instr(22 downto 20)) when s_isImm = '1' else std_logic_vector(s_instr(19 downto 17));
    s_a3 <= std_logic_vector(s_instr(25 downto 23));
     
    s_sign_imm <=("000" & s_instr(16 downto 0)) when s_isImm = '1' else s_instr(19 downto 0);
